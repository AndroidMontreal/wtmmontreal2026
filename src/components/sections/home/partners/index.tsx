                    ...
                    {partnersList.map((partner, index) => {
                        const Content = (
                            ...
                            >
                                {partner.logo ? (
                                    <div
                                        className="relative inline-flex transition-all duration-500 hover:-translate-y-2 hover:scale-105 hover:drop-shadow-xl hover:brightness-110 hover:saturate-110">
                                        <Image
                                            src={partner.logo}
                                            alt={partner.name}
                                            width={400}
                                        ...
                                        className="text-sm font-bold text-slate-300 uppercase tracking-wider group-hover:text-[#00A896] transition-colors duration-300 text-center">
                    {partner.name}
                  </span>
                                )}
                            </motion.div>
