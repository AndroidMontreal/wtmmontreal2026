...
export default function SchedulePage({ data, schedule, sessions, speakers, stats }: SchedulePageProps) {
  ...
  const handleQrClick = () => {
    // URL to Canva schedule file
    window.open('https://www.canva.com/design/DAGez_X9_mw/YskNr_-vEj_Zit_v_X_vXw/view', '_blank');
  };
  ...
  return (
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-col lg:flex-row gap-12 mb-24 items-start relative">
        ...
        <aside className="lg:w-96 w-full shrink-0 space-y-8 lg:sticky lg:top-40">
          {/* QR Code Card */}
          <div className="bg-white/40 backdrop-blur-md border border-slate-200/60 p-8 rounded-[2.5rem] shadow-xl overflow-hidden group/sidebar relative">
            ...
            <div className="relative z-10">
              ...
              <a 
                ...
                className="bg-white border border-slate-100 p-6 rounded-3xl mb-8 flex flex-col items-center cursor-pointer hover:shadow-lg transition-all group active:scale-95"
              >
                <div className="w-72 h-72 p-2 flex items-center justify-center bg-white rounded-lg">
                  <img src="/images/schedule/canva_agenda_qr.svg" alt="Canva Agenda QR Code" className="w-full h-full" />
                </div>
